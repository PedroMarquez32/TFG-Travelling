...
export const ADMIN_ROUTES: Routes = [
  {
    ...
    children: [
      ...
      {
        path: 'destinations',
        loadComponent: () => import('./destinations/admin-destinations.component')
          .then(m => m.AdminDestinationsComponent)
      },
      {
        path: 'bookings',
        loadComponent: () => import('./bookings/admin-bookings.component')
          .then(m => m.AdminBookingsComponent)
      },
      {
        path: 'finances',
        loadComponent: () => import('./finances/admin-finances.component')
